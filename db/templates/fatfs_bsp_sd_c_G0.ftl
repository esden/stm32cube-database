...
/**
 ******************************************************************************
  * @file    bsp_driver_sd.c for G0 (based on stm32g081b_eval_sd.c)
...
/** STM32G081BEVAL_SD_Private_Types_Definitions Types Definitions
  * 
  */
typedef struct {
    uint8_t r1;
...
/** STM32G081B_EVAL_SD_Private_Constants Private Constants
  * 
  */
...
/** STM32G081B_EVAL_SD_Private_Variables Private Variables
* 
*/
...
/** STM32G081B_EVAL_SD_Private_Functions Private Functions
* 
*/
...
/* External functions (in stm32g081b_eval.c) */
__weak void SD_IO_Init(void) {}
__weak void SD_IO_CSState(uint8_t state) {}
__weak void SD_IO_WriteReadData(const uint8_t *DataIn, uint8_t *DataOut, uint16_t DataLength) {}
__weak uint8_t SD_IO_WriteByte(uint8_t Data) { return 0; }

/* Exported functions ---------------------------------------------------------*/

/* STM32G081B_EVAL_SD_Exported_Functions
* 
*/
...
/* USER CODE BEGIN BeforeGetCardInfoSection */
/* can be used to modify previous code / undefine following code / add code */
/* USER CODE END BeforeGetCardInfoSection */
...
/* USER CODE BEGIN BeforeUtilityFunctionsSection */
/* can be used to modify previous code / undefine following code / add code */
/* USER CODE END BeforeUtilityFunctionsSection */
/**
