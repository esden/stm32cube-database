...
[#if (BUTTON?? && BUTTON == "1") || (BUTTON2?? && BUTTON2 == "1") || (BUTTON3?? && BUTTON3 == "1") || (BUTTON4?? && BUTTON4 == "1")][#--GPIO--]
  ...
  [#if BUTTON == "1"][#--EXTI--]
    #tBSP_PB_Init(BUTTON_SW1, BUTTON_MODE_EXTI);
  [/#if]
  [#if BUTTON2 == "1"][#--EXTI--]
    #tBSP_PB_Init(BUTTON_SW2, BUTTON_MODE_EXTI);
  [/#if]
  [#if BUTTON3 == "1"][#--EXTI--]
    #tBSP_PB_Init(BUTTON_SW3, BUTTON_MODE_EXTI);
  [/#if]
#n
[/#if]
...
[#if (BUTTON?? && BUTTON == "2") || (BUTTON2?? && BUTTON2 == "2") || (BUTTON3?? && BUTTON3 == "2") || (BUTTON4?? && BUTTON4 == "2")][#--GPIO--]
  ...
  [#if BUTTON == "2"]
    #tBSP_PB_Init(BUTTON_SW1, BUTTON_MODE_GPIO);
  [/#if]
  [#if BUTTON2 == "2"]
    #tBSP_PB_Init(BUTTON_SW2, BUTTON_MODE_GPIO);
  [/#if]
  [#if BUTTON3 == "2"]
    #tBSP_PB_Init(BUTTON_SW3, BUTTON_MODE_GPIO);
  [/#if]
#n
[/#if]
[/#compress]
