...
{
    /* USER CODE BEGIN HAL_DMA2D_SetMode */
    ...
    /* USER CODE END HAL_DMA2D_SetMode */
}
...
static void DMA2D_XferErrorCallback(DMA2D_HandleTypeDef* hdma2d)
{
    ...
    /* USER CODE BEGIN DMA2D_XferErrorCallback */


    /* USER CODE END DMA2D_XferErrorCallback */
}
...
{
    /* USER CODE BEGIN STM32H7DMA::STM32H7DMA */


    /* USER CODE END STM32H7DMA::STM32H7DMA */
...
void STM32H7DMA::initialize()
{
    ...
    /* USER CODE BEGIN STM32H7DMA::initialize */
...
BlitOperations STM32H7DMA::getBlitCaps()
{
    ...
    /* USER CODE BEGIN STM32H7DMA::getBlitCaps */
    ...
    /* USER CODE END STM32H7DMA::getBlitCaps */
}

void STM32H7DMA::setupDataCopy(const BlitOp& blitOp)
{

    /* USER CODE BEGIN STM32H7DMA::setupDataCopy */
   ...
   /* USER CODE END STM32H7DMA::setupDataCopy */
}

void STM32H7DMA::setupDataFill(const BlitOp& blitOp)
{
    /* USER CODE BEGIN STM32H7DMA::setupDataFill */
    ...
    /* USER CODE END STM32H7DMA::setupDataFill */

}
void STM32H7DMA::start()
{
    /* USER CODE BEGIN STM32H7DMA::start */
    ...
    /* USER CODE END STM32H7DMA::start */
