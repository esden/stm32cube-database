 ...
 * This class is for use ONLY with the DSI peripheral. If you have a regular RGB interface display, use the STM32H7HAL.cpp class instead.
 *
...
void STM32H7HAL_DSI::setFrameBufferStartAddress(void* adr, uint16_t depth, bool useDoubleBuffering, bool useAnimationStorage)
{
    ...
    /* USER CODE BEGIN setFrameBufferStartAddress */
    ...
    /* USER CODE END setFrameBufferStartAddress */
}
...
{
    /* USER CODE BEGIN enableLCDControllerInterrupts */
    ...
    /* USER CODE END enableLCDControllerInterrupts */
...
{
    /* USER CODE BEGIN beginFrame */


    refreshRequested = false;
    return HAL::beginFrame();

    /* USER CODE END beginFrame */
