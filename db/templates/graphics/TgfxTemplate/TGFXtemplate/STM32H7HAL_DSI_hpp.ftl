 ...
 *
 * @brief HAL implementation for STM32H7, for DSI displays
 *
 *        HAL implementation for STM32H7. Based on the ST CubeH7 API. This version uses the DSI display peripheral.
