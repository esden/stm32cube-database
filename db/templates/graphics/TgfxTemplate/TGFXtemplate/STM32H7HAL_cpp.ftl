...
{
    /* USER CODE BEGIN getTFTCurrentLine */
    ...
    /* USER CODE END getTFTCurrentLine */
}
...
void STM32H7HAL::enableLCDControllerInterrupt()
{
    ...
    /* Enable line and FIFO underrun interrupts */
...
{
    /* USER CODE BEGIN flushFrameBuffer */
    ...
    /* USER CODE END flushFrameBuffer */
}

extern "C"
void HAL_LTDC_LineEvenCallback(LTDC_HandleTypeDef *hltdc)
{
    /* USER CODE BEGIN HAL_LTDC_LineEvenCallback */
    ...
    /* USER CODE END HAL_LTDC_LineEvenCallback */
}
