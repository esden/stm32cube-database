 ...
 * ---------------------------------------------------------------------------
 */
// STEP 0 : en commentaires, car tout ca entre en conflit avec l'interface
//          usart, et la stack ble ne fournit pas d'implementation.
//          Le type UART_status_t est egalement une surcouche, incomplete, du
//          type UTIL_ADV_TRACE_Status_t.
//
///**
// * @brief  List the UART function status.
// * list of the returned status value, any negative value is corresponding to
// * an error.
// */
//typedef enum
//{
//  UART_STATUS_OK            =  0,  /*!< Operation terminated successfully.*/
//  UART_STATUS_HW_ERROR      = -2,  /*!< Hardware Error.                   */
//  UART_STATUS_UNKNOWN_ERROR = -4,  /*!< Unknown Error.                    */
//} UART_status_t;
//
///** 
// * @brief  Init the UART and associated DMA.
// * @param  cb tx function callback.
// * @return @ref UART_status_t
// */
//UART_status_t UART_Init( void (*cb)(void*) );
//
///** 
...
// * @return @ref UART_status_t
// */
//UART_status_t UART_TransmitDMA( uint8_t *pdata,
//                                uint16_t size );
//
///** 
...
// * @return @ref UART_status_t
// */
//UART_status_t UART_StartRx( void (*cb)(uint8_t *pdata,
//                                       uint16_t size,
//                                       uint8_t error) );
