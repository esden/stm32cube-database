...
[/#if]
[#if ((myHash["CFG_STATIC_RANDOM_ADDRESS"]?number == 2) && (myHash["CFG_BD_ADDRESS_DEVICE"] == "GAP_STATIC_RANDOM_ADDR"))]
/**
 * Define Static Unique Random Address LSB fixed for lifetime of the device
 */
#define CFG_STATIC_UNIQUE_RANDOM_ADDR_LSB (${myHash["CFG_STATIC_UNIQUE_RANDOM_ADDR_LSB"]})
[/#if]
