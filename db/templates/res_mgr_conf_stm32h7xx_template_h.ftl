    ...
    [#list IP.configModelList as configModel]
        [#list configModel.refConfigFiles as refConfigFile]
            [#list refConfigFile.arguments as argument]
                [#if argument.name?? && argument.name?contains("RESMGR_REQUEST_") && argument.value??]
...
[#list IPdatas as IP]
    [#list IP.configModelList as configModel]
        [#list configModel.refConfigFiles as refConfigFile]
            [#list refConfigFile.arguments as argument]
                [#if argument.name?? && argument.name?contains("RESMGR_REQUEST_") && argument.value?? && argument.value!=""]
