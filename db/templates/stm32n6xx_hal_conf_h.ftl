...
[#assign allModules = ["ADC","BSEC","CRC","CRYP","DCMI","DCMIPP","DMA2D","DTS","ETH","EXTI","FDCAN","GFXMMU","GFXTIM","HASH","HCD","I2C","I2S","I3C","ICACHE","IRDA","IWDG","JPEG","LPTIM","LTDC","MCE","MDF","MMC","NAND","NOR","PCD","PKA","PSSI","RAMCFG","RIF","RNG","RTC","SAI","SD","SDRAM","SMARTCARD","SMBUS","SPDIFRX","SPI","SRAM","TIM","UART","USART","WWDG","XSPI","CACHEAXI","MDIOS","GPU2D"]]
